...
int main()
{
    ...
    // LOAD MUSIC TO PLAY
    sf::Music music;
    if (!music.openFromFile("Music/bringMeToLife.mp3"))
        return EXIT_FAILURE;
    // PLAY MUSIC
    music.setVolume(20);
    music.play();
    ...
    sf::Text text1(DigimonTo_String(*agumon), font, 25);
    text1.setFillColor(sf::Color::Black);
    text1.setPosition(90, 220);

    // LOAD STATS STRING TO BOX 2
    sf::Text text2(DigimonTo_String(*gabumon), font, 25);
    ...
    {
        // PROCESS TIME
        sf::Time time = frames.getElapsedTime();
        // PROCESS EVENTS
        sf::Event event;
